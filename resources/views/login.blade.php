...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('login/assets/images/favicon.png') }}" type="image/x-icon">

    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{ asset('login/assets/css/animate.css') }}">

    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ asset('login/assets/css/tailwind.css') }}">

    <!-- Custom Styles -->
    <link rel="stylesheet" href="{{ asset('login/assets/css/styles-custom.css') }}">
  ...
  <body>
      ...
      <div class="container mx-auto px-4">
        <div class="relative flex items-center justify-between -mx-4">
          <div class="max-w-full px-4 w-60">
            <a href="{{ route('login') }}" class="block w-full py-5 navbar-logo">
              <img
                src="{{ asset('login/assets/images/logo/logo.svg') }}"
                alt="logo"
                class="w-full dark:hidden"
              />
              <img
                src="{{ asset('login/assets/images/logo/logo-white.svg') }}"
                alt="logo"
    ...
    >
      ...
      <div>
        <span class="absolute left-0 top-0 z-[-1]">
          <img src="{{ asset('login/assets/images/footer/shape-1.svg') }}" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
          <img src="{{ asset('login/assets/images/footer/shape-3.svg') }}" alt="" />
        </span>
    ...
    >
      ...
      <span class="block max-w-[88px] w-full">
        <img
          src="{{ asset('login/assets/images/brands/tailgrids.svg') }}"
          alt="tailgrids"
          class="dark:hidden"
        />
        <img
          src="{{ asset('login/assets/images/brands/tailgrids-white.svg') }}"
          alt="tailgrids"
          class="hidden dark:block"
        />
      </span>
