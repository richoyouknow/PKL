        ...
        <main class="tw-flex-1 tw-w-full tw-max-w-[1200px] tw-mx-auto tw-p-4 md:tw-p-8">
            ...
            <div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 tw-gap-6">
                ...
                <div class="lg:tw-col-span-4 xl:tw-col-span-3 tw-flex tw-flex-col tw-gap-6">
                    ...
                    <div
                        ...
                        <div class="tw-relative tw-mb-4 tw-group tw-cursor-pointer">
                            ...
                            <div
                                class="tw-absolute tw-bottom-0 tw-right-0 tw-bg-primary tw-text-white tw-p-1.5 tw-rounded-full tw-shadow-md tw-border-2 tw-border-white dark:tw-border-surface-dark">
                                <span class="material-symbols-outlined tw-text-[18px]">edit</span>
                            </div>
                        </div>
                        <h2 class="tw-text-text-primary-light dark:tw-text-text-primary-dark tw-text-xl tw-font-bold">Budi
                            Santoso</h2>
                        <p class="tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-text-sm tw-mt-1">Anggota
                            Sejak 2020
                        </p>
                        ...
                        <div class="tw-w-full tw-flex tw-flex-col tw-gap-4 tw-text-left">
                            ...
                            <div class="tw-flex tw-items-start tw-gap-3">
                                <span
                                    class="material-symbols-outlined tw-text-text-secondary-light dark:tw-text-text-secondary-dark">account_balance_wallet</span>
                                <div>
                                    <p
                                        class="tw-text-xs tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-font-medium">
                                        No. Rekening</p>
                ...
                <div class="lg:tw-col-span-8 xl:tw-col-span-9 tw-flex tw-flex-col tw-gap-6">
                    <!-- Section: Informasi Akun & Keanggotaan -->
                    <div
                        ...
                        <div class="tw-p-6 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-y-6 tw-gap-x-8">
                            ...
                            <div>
                                <p class="tw-text-sm tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-mb-1">
                                    Keterangan</p>
                                <p
                                    class="tw-text-base tw-font-medium tw-text-text-primary-light dark:tw-text-text-primary-dark tw-italic tw-text-opacity-80">
                                    Anggota prioritas</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="tw-flex tw-items-start tw-gap-2">
                                        ...
                                        <p
                                            ...
                                            Jl. Kebon Jeruk No. 45, RT 01/RW 02, Jakarta Barat, DKI Jakarta</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="tw-p-6 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-y-6 tw-gap-x-8">
                            ...
                            <div class="md:tw-col-span-2">
                                ...
                                <p
                                    class="tw-text-base tw-font-medium tw-text-text-primary-light dark:tw-text-text-primary-dark">
                                    Ruko Grand Wijaya Center, Jl. Wijaya II, Jakarta Selatan</p>
                            </div>
                        </div>
                    </div>
                </div>
