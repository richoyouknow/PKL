...
<div id="tailwind-scope">
    <div class="tw-relative tw-min-h-screen tw-w-full tw-bg-background-light dark:tw-bg-background-dark tw-py-10">
        <div class="tw-max-w-7xl tw-mx-auto tw-px-4">
            ...
            <!-- HEADER -->
            <div class="tw-flex tw-flex-wrap tw-justify-between tw-items-start tw-gap-4 tw-mb-8 animated slideInDown">
                <div>
            ...
            <div
                ...
                <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 lg:tw-grid-cols-3 tw-gap-4">
                    ...
                    <div class="tw-flex tw-flex-col tw-border-t tw-py-4">
                        ...
                        <p class="tw-text-slate-800 dark:tw-text-slate-200 tw-text-sm tw-font-medium">Budi Santoso</p>
                    </div>

                    <div class="tw-flex tw-flex-col tw-border-t tw-py-4">
                        <p class="tw-text-slate-500 tw-text-sm">No Identitas</p>
                        <p class="tw-text-slate-800 dark:tw-text-slate-200 tw-text-sm tw-font-medium">3301010101010001</p>
                    </div>
                    ...
                    <div class="tw-flex tw-flex-col tw-border-t tw-py-4 tw-bg-primary/10 dark:tw-bg-primary/20 tw-rounded-lg tw-col-span-2 tw-p-4">
            ...
            <div
                ...
                <div class="tw-overflow-x-auto">
                    ...
                    <table class="tw-w-full tw-text-sm tw-text-left">
                        ...
                        <thead class="tw-bg-slate-100 dark:tw-bg-slate-800 tw-text-slate-700 dark:tw-text-slate-300 tw-uppercase">
                            <tr>
